// Shared visualization engine for all ice sheet pages
        ...
        displayArea.innerHTML = `
            <div style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px;">
                <div style="text-align: center; margin-bottom: 25px;">
                    ...
                    <p style="font-size: 0.9rem; color: #cccccc; margin-bottom: 10px; font-style: italic;">Simplified Impact Visualization From Space.Com</p>
